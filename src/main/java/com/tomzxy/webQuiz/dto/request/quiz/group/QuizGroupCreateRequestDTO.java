package com.tomzxy.webQuiz.dto.request.quiz.group;
...
public class QuizGroupCreateRequestDTO implements Serializable {
    ...
    Integer timeQuiz;  // Thời lượng làm bài (tính bằng phút)

    boolean isTimed;  // Bài quiz có giới hạn thời gian hay không, bổ sung cho timeQuiz
